# Produce sources — archive for grocery-counter cards

Retrieved 2026-09-16 via firecrawl scrape. Verbatim quotes only, in blockquotes.
Truncation marked `[…]`. EWG cited only as "a standard" for residue ranking, never
a health-outcome claim (the Kale Dirty Dozen subtitle is deliberately excluded — see
Leafy Greens). No medical claims, no prices, no yield figures.

Dropped sources (fetched but unusable, noted so they are not re-fetched):
- MSU Michigan Fresh **lettuce** and **spinach** fact sheets — genuine 404s that render as
  MSU CANR site-search boilerplate ("Search Filters", "General Information", "MSU
  Horticulture Gardens"), not real article content.
- USApple "Apple Storage Backgrounder" (usapple.org/news-resources/apple-storage-backgrounard)
  — 404: "Not Found. Sorry, but the page you were trying to view does not exist."
- UC Davis Postharvest slug `apple-(honeycrisp)` — 404 ("Page not found"). Replaced with the
  `apple-gala` fact sheet below.
- Florida Department of Citrus (floridacitrus.org/oranges) — reachable but pure nutrition/
  recipe/marketing copy, no selection or storage guidance.
- Washington State Fruit Commission / Northwest Cherries — reachable but purely promotional,
  no selection or storage guidance.
- National Onion Association select page at onions-usa.org/all-about-onions/how-to-select-cut-prepare-store/
  — genuine 404 ("It looks like nothing was found at this location. Maybe try a search?"),
  previously mis-logged as reachable. Replaced with onions-usa.org/all-about-onions/how-tos/.
- UC Davis Postharvest slug `beet` (postharvest.ucdavis.edu/produce-facts-sheets/beet) — 404
  ("Page not found"). Replaced with Ohioline (OSU Extension) HYG-5510 below.

---

## 1. Root vegetables — carrots, potatoes, sweet potatoes, beets

### Source: Michigan Fresh — "Selecting and Storing Potatoes" (mf-potatoes)
- URL: https://www.canr.msu.edu/resources/michigan_fresh_selecting_and_storing_potatoes_e3079
- Publisher: Michigan State University Extension (Michigan Fresh series)
...
### Source: University of Maine Cooperative Extension — "Carrots 101: Selection, Storage, and Cooking Tips for Maximum Flavor"
- URL: https://extension.umaine.edu/publications/carrots-101/
- Publisher: University of Maine Cooperative Extension (byline: Kate Yerxa, MS, RD, Extension Professor)
- Retrieved: 2026-09-16

> "When selecting carrots, look for ones that are firm and well-colored. Avoid carrots with a large amount of green at the top or wilted, flabby, cracked carrots. If you buy carrots with the greens still attached, choose the carrots that have bright green tops and are fresh-looking."

> "To keep your carrots fresh for longer, store them in a closed plastic bag or container in the refrigerator. They can stay fresh for up to two weeks. If you purchase or harvest carrots with leafy green tops, remove them before storing the carrots in the refrigerator. The tops can cause the carrots to wilt. If your carrots become wilted, you can revive them by soaking them in cold water."

### Source: UC Davis Postharvest — "Sweet Potato"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/sweet-potato
- Publisher: UC Davis Postharvest Technology (authors: Marita Cantwell, Trevor V. Suslow; last updated August 2001)
- Retrieved: 2026-09-16
...
> "_**Chilling injury.**_ Sweet potato roots are very sensitive to chilling injury at temperatures of 12.5°C (55°F) or below. Symptoms of chilling injury include fungal decay, internal pulp browning, and root shriveling."

### Source: Ohioline (Ohio State University Extension) — "Selecting, Storing, and Serving Ohio Beets" (HYG-5510)
- URL: https://ohioline.osu.edu/factsheet/hyg-5510
...
### Source: EWG Shopper's Guide to Pesticides in Produce — full list (as a standard, residue ranking only)
- URL: https://www.ewg.org/foodnews/full-list.php
- Publisher: Environmental Working Group
- Retrieved: 2026-09-16

> "The Clean Fifteen™ ... These 15 items had the lowest amounts of pesticide residues, according to EWG's analysis of the most recent USDA data."

Carrots rank #13 on the 2026 Clean Fifteen list per this same standard.

---

## 2. Brassicas — broccoli, cauliflower, cabbage

### Source: Michigan Fresh — "Broccoli"
- URL: https://www.canr.msu.edu/resources/michigan_fresh_broccoli
- Publisher: Michigan State University Extension
- Retrieved: 2026-09-16

> "Store broccoli in the refrigerator in a plastic bag with holes."

> "Wash broccoli under cool running Do not use soap." [sic — as fetched; likely a dropped "water." before "Do not use soap" in the source's own text]
...
### Source: Michigan Fresh — "Cauliflower"
- URL: https://www.canr.msu.edu/resources/michigan_fresh_cauliflower
- Publisher: Michigan State University Extension
- Retrieved: 2026-09-16

> "Pick or purchase cauliflower heads that are not bruised or damaged."

> "Wash cauliflower under cool running Do not use soap." [sic — as fetched]

> "Keep cauliflower away from raw meat and meat juices to prevent cross-contamination."

### Source: Michigan Fresh — "Cabbage"
- URL: https://www.canr.msu.edu/resources/michigan_fresh_cabbage
- Publisher: Michigan State University Extension
- Retrieved: 2026-09-16
...
### Source: EWG Shopper's Guide — full list (standard only)
- URL: https://www.ewg.org/foodnews/full-list.php
- Retrieved: 2026-09-16

> "The Clean Fifteen™ ... These 15 items had the lowest amounts of pesticide residues, according to EWG's analysis of the most recent USDA data."

Cabbage ranks #08 and Cauliflower ranks #09 on the 2026 Clean Fifteen list per this same standard.

---

## 3. Alliums — onions, garlic

### Source: National Onion Association — "How to Select, Cut, Prepare & Store Onions"
- URL: https://www.onions-usa.org/all-about-onions/how-tos/
- Publisher: National Onion Association
- Retrieved: 2026-09-16
...
### Source: National Onion Association — "Storage and Handling"
- URL: https://onions-usa.org/all-about-onions/storage-and-handling/
- Publisher: National Onion Association
- Retrieved: 2026-09-16
...
### Source: UC Davis Postharvest — "Onions (Dry)"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/onions-dry
- Publisher: UC Davis Postharvest Technology / Department of Plant Sciences (author: Trevor V. Suslow; last updated August 1996)
- Retrieved: 2026-09-16
...
> "_**Storage.**_ Mild onions: Typically 0.5 to 1 month at 0°C (32°F). Pungent Onions: Typically up to 6 to 9 months at 0°C (32°F) depending on the cultivar"

> "Storage between 5-25°C (41-75°F) favors sprouting and is not recommended for extended periods."

### Source: UC Davis Postharvest — "Garlic"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/garlic
- Publisher: UC Davis Postharvest Technology (author: Marita Cantwell; last updated August 2000)
- Retrieved: 2026-09-16
...
> "Garlic can be kept in good condition for 1-2 months at ambient temperatures (20°C-30°C [68°F-86°F]) under low relative humidity (<75%). However under these conditions, bulbs will eventually become soft, spongy and shriveled due to water loss. For long-term storage, garlic is best maintained at temperatures of -1°C to 0°C (30°F-32°F) with low relative humidity (60-70%). [...] Under these conditions garlic can be stored for more than 9 months."

> "Garlic will eventually lose dormancy, signaled by internal development of the sprout. This occurs most rapidly at intermediate storage temperatures of 5°C-18°C (41°F-65°F). Garlic odor is easily transferred to other products and should be stored separately."

### Source: EWG Shopper's Guide — full list (standard only)
- URL: https://www.ewg.org/foodnews/full-list.php
- Retrieved: 2026-09-16

Onion ranks #05 on the 2026 Clean Fifteen list per this standard.

---

## 4. Leafy greens — lettuce, spinach, kale

### Source: UC Davis Postharvest — "Lettuce (Romaine and Loose-Leaf)"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/lettuce-romaine
- Publisher: UC Davis Postharvest Technology (authors: Marita Cantwell, Pengxia Li, Yingtong Zhang, Huali Hu, Xinye Liu, Noah X. Kulchin, Irwin R. Donis-González; last updated September 2025)
- Retrieved: 2026-09-16

> "Romaine or Cos lettuce is an elongated heading lettuce type. Maturity is based on the number of leaves and head development. A very loose or easily compressible head is immature, and a very firm or hard head is overmature."

> "After trimming outer leaves, the leaves should be a bright to dark green color (tinged with red in some cultivars) with the inner leaves of the head being yellow or light green. [...] Leaves should be crisp and turgid, and free from insects, decay, or mechanical damage."

> "Storing near 0°C (32°F) is required to optimize the postharvest life of Romaine and leafy lettuce. A shelf-life of around 21 days is expected at this temperature for romaine lettuce. At 5°C (41°F), a shelf life of about 14 days can be expected if no ethylene is present in the environment."

### Source: UC Davis Postharvest — "Spinach"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/spinach
- Publisher: UC Davis Postharvest Technology (authors: Trevor V. Suslow, Marita Cantwell; last updated May 1998)
- Retrieved: 2026-09-16

> "Spinach, whether bunched or as leaves, should be uniformly green (generally not yellow-green), fully turgid, fairly clean, and free from serious damage."
...
### Source: MSU Extension — "Cultivate Michigan featured local foods for institutions" (news article; no dedicated Michigan Fresh kale fact sheet exists)
- URL: https://www.canr.msu.edu/news/2016_featured_local_foods_for_institutions
- Publisher: Michigan State University Extension
- Retrieved: 2026-09-16
...
(The article's adjacent sentence claiming kale health benefits/cholesterol-lowering is a medical claim and is deliberately not quoted.)

### Source: EWG Shopper's Guide — full list (standard only; health-outcome subtitle excluded per claim lock)
- URL: https://www.ewg.org/foodnews/full-list.php
- Retrieved: 2026-09-16

> "The 2026 Dirty Dozen™ ... Of the 47 items included in our analysis, these 12 fruits and vegetables were most contaminated with pesticides:"

> "Spinach has more pesticide residues by weight than any other type of produce."

Spinach ranks #47 on the Dirty Dozen list per this standard. Kale/Collard/Mustard Greens ranks #46; its subtitle language is a health-outcome claim and is deliberately NOT quoted here — only the bare ranking fact may be used if EWG is cited for kale at all.

---

## 5. Bell peppers

### Source: UC Davis Postharvest — "Bell Pepper"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/bell-pepper
- Publisher: UC Davis Postharvest Technology (author: Marita Cantwell; last updated April 1996)
- Retrieved: 2026-09-16

> "Green Peppers: fruit size, firmness, color / Colored Peppers: minimum 50% coloration"

> "Uniform shape, size and color typical of variety; Firmness; Freedom from defects such as cracks, decay, sunburn"
...
> "_**Blossom End Rot.**_ This disorder occurs as a slight discoloration or a severe dark sunken lesion at the blossom end; it is caused by temporary insufficiencies of water and calcium and may occur under high temperature conditions when the peppers are rapidly growing."

### Source: Michigan Fresh — "Peppers"
- URL: https://www.canr.msu.edu/resources/michigan_fresh_peppers
- Publisher: Michigan State University Extension
- Retrieved: 2026-09-16

> "Pick or purchase peppers that are not bruised or damaged."

> "Wash peppers under cool running Do not use soap." [sic — as fetched]
...
### Source: Oregon State University Extension — "Picking and storing apples and pears" (FS 147)
- URL: https://extension.oregonstate.edu/gardening/fruit-vegetable/picking-storing-apples-pears
- Publisher: Oregon State University Extension Service (FS 147, revised December 2022)
- Retrieved: 2026-09-16
...
### Source: UC Davis Postharvest — "Apple (Gala)"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/apple-gala
- Publisher: UC Davis Postharvest Technology (authors: Elizabeth J. Mitcham, Carlos H. Crisosto, Adel A. Kader (in memoriam); last updated July 1997)
- Retrieved: 2026-09-16

> "Ground color change from green to light-green or white may be the most useful indicator of maturity for harvesters"

> "Firmness, crispness, lack of mealiness; Flavor, including soluble solids, titratable acidity and flavor volatiles; Freedom from defects such as bruising, decay, stem or blossom-end cracks, bitter pit, insect injury, etc."

> "Optimum Temperature: 0 ± 1°C (32 ± 2°F). Cool rapidly, this apple softens quickly."

### Source: UC Davis Postharvest — "Pear: Bartlett"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/pear-bartlett
- Publisher: UC Davis Postharvest Technology (authors: Elizabeth J. Mitcham, Carlos H. Crisosto, Adel A. Kader (in memoriam); last updated May 1996)
- Retrieved: 2026-09-16
...
> "Fruit shape, size, and freedom from insect damage, mechanical injuries (impact, compression, and/or vibration bruising), decay, and other defects; Sweet taste, pleasant aroma, and juicy, buttery texture are desired eating characteristics of ripe pears (flesh firmness range between 2 and 4 pounds-force)"

> "Optimum Temperature: -1 to 0°C (30 to 32°F)"

### Source: Michigan Fresh — "Apples"
- URL: https://www.canr.msu.edu/resources/michigan_fresh_apples
- Publisher: Michigan State University Extension
- Retrieved: 2026-09-16

> "Jonathan, Empire, Ida Red, McIntosh and Golden Delicious varieties are recommended for baking and cooking."

> "Wash apples thoroughly under cool running Do not use soap." [sic — as fetched]

> "You can store apples in the refrigerator in a plastic bag with holes for Store large quantities of apples in a cool place, between 32 and 40 °F. Properly stored apples will keep up to a month. Store canned apple products in a cool, dry area." [sic — merged/garbled sentence as fetched from the source]

> "Keep apples away from raw meat and meat juices to prevent cross contamination."

### Source: Michigan Fresh — "Pears"
- URL: https://www.canr.msu.edu/resources/michigan_fresh_pears
- Publisher: Michigan State University Extension
- Retrieved: 2026-09-16

> "Pick or purchase pears that are not bruised or damaged."

> "Wash pears under cool running Do not use soap." [sic — as fetched]
...
Apples rank #40 and Pears rank #38 on the 2026 Dirty Dozen list per this standard.

---

## 7. Citrus — lemons, limes, oranges

### Source: UC Davis Postharvest — "Orange"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/orange
- Publisher: UC Davis Postharvest Technology (authors: Mary Lu Arpaia, Adel A. Kader (in memoriam); last updated May 1999)
- Retrieved: 2026-09-16
...
> "Quality Indices: Color intensity and uniformity; Firmness; Size; Shape; Smoothness; Freedom from decay; Freedom from defects including physical damage (abrasions and bruising), skin blemishes and discoloration, freezing damage, chilling injury, and insect damage"

> "Optimum Temperature: 3-8°C (38-46°F) for up to 3 months, depending on cultivar, maturity-ripeness stage at harvest and production area. Some Florida-grown cultivars can be kept at 0-1°C (32-34°F). Arizona-grown Valencia oranges should be kept at 9°C (48°F)."
...
### Source: UC Davis Postharvest — "Lemon"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/lemon
- Publisher: UC Davis Postharvest Technology (authors: Mary Lu Arpaia, Adel A. Kader (in memoriam); last updated May 1999)
- Retrieved: 2026-09-16

> "Maturity Indices: A minimum juice content by volume of 28 or 30% depending on grade; color lemons picked at the dark-green stage have the longest postharvest life while those picked fully-yellow must be marketed more rapidly."

> "Quality Indices: Yellow color intensity and uniformity; Size; Shape; Smoothness; firmness; Freedom from decay; Freedom from defects including freezing damage, drying, mechanical damage, rind stains, red blotch, shriveling, and discoloration"

> "Optimum Temperature: 12-14°C (54-57°F) depending on cultivar, maturity-ripeness stage at harvest, production area, and duration of storage and transport (can be up to 6 months)."

### Source: UC Davis Postharvest — "Lime"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/lime
- Publisher: UC Davis Postharvest Technology (authors: Mary Lu Arpaia, Adel A. Kader (in memoriam); last updated May 1999)
- Retrieved: 2026-09-16

> "Maturity Indices: Juice content by volume of 30% or higher and color (mature-green limes have a much longer postharvest-life than those picked when yellow; the latter must be marketed soon after harvest)."
...
### Source: USDA SNAP-Ed Connection — "Oranges" (Seasonal Produce Guide)
- URL: https://snaped.fns.usda.gov/resources/nutrition-education-materials/seasonal-produce-guide/oranges
- Publisher: USDA Food and Nutrition Service, SNAP-Ed Connection
- Retrieved: 2026-09-16

> "There are over 600 different types of oranges grown around the world. Oranges can be stored at room temperature for up to one week and in the refrigerator for up to three weeks."

> "Fun fact: About 85% of all oranges grown are used to produce juice."

---

## 8. Stone fruit — peaches, plums, cherries

### Source: UC Davis Postharvest — "Cherry"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/cherry
- Publisher: UC Davis Postharvest Technology (authors: Carlos H. Crisosto, Elizabeth J. Mitcham, Adel A. Kader (in memoriam); last updated May 1996)
- Retrieved: 2026-09-16

> "Skin color and soluble solids content (SSC) are the main criteria used to judge fruit maturity. Minimum maturity in California requires that the entire cherry surface have a minimum of light red color and/or 14 to 16% SSC, depending on the variety."

> "Freedom from cracks, bird pecks, shriveling, decay or misshappen fruit (doubles, spurs); Green fleshy stems are often associated with freshness and quality"

> "Optimum Temperature: -0.5 ± 0.5°C (31 ± 1°F)"

> "Cherry response to ethylene is minimal. Ethylene does not accelerate cherry ripening."

> "_**Pitting.**_ An indentation in the surface of the fruit caused by the collapse of cells under the skin. Thought to result from impact injury."

### Source: UC Davis Postharvest — "Plum"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/plum
- Publisher: UC Davis Postharvest Technology (authors: Carlos H. Crisosto, Elizabeth J. Mitcham, Adel A. Kader (in memoriam); last updated May 1996)
- Retrieved: 2026-09-16
...
> "Optimum Temperature: -1.0 to 0°C (30.5-32°F). Freezing point varies depending on SSC."

> "Most of the plums harvested at the California Well-Mature stage (higher than US-Mature) will ripen properly without exogenous ethylene application."

> "_**Internal Breakdown or Chilling Injury.**_ This physiological problem is characterized by flesh translucency, flesh internal browning, flesh mealiness, flesh bleeding, failure to ripen and flavor loss. [...] Fruit stored within the \"killing temperature range\" 2-8°C (36-46°F) are more susceptible to this problem."

### Source: UC Davis Postharvest — "Nectarine & Peach"
- URL: https://postharvest.ucdavis.edu/produce-facts-sheets/peach
- Publisher: UC Davis Postharvest Technology (authors: Carlos H. Crisosto, Elizabeth J. Mitcham, Adel A. Kader (in memoriam); last updated May 1996)
- Retrieved: 2026-09-16
...
> "Optimum Temperature: -1 to 0°C (30.5-32°F). Freezing point varies depending on SSC from -3 to -2.5°C (26.5 to 29.5°F)"

> "In general peaches and nectarines harvested at Well Mature (higher than US-Mature) will ripen properly without exogenous ethylene application. Ethylene application to fruit harvested at the US-Mature maturity will only ripen the fruit more uniformly without speeding up the rate of ripening."

> "_**Inking (Black Staining).**_ It is a comestic problem affecting only the skin of peaches and nectarines. [...] Inking occurs as a result of abrasion damage in combination with heavy metals (iron, copper and aluminum) contamination."

### Source: Michigan Fresh — "Cherries"
- URL: https://www.canr.msu.edu/resources/michigan_fresh_cherries
- Publisher: Michigan State University Extension
- Retrieved: 2026-09-16

> "Select cherries that are not bruised or damaged."

> "Wash cherries thoroughly under cool running Do not use soap." [sic — as fetched]
...
### Source: Michigan Fresh — "Peaches"
- URL: https://www.canr.msu.edu/resources/michigan_fresh_peaches
- Publisher: Michigan State University Extension
- Retrieved: 2026-09-16

> "Pick or purchase peaches that are not bruised or damaged."

> "Wash peaches under cool running Do not use soap." [sic — as fetched]

> "Keep peaches away from raw meat and meat juices to prevent cross-contamination."

### Source: Michigan Fresh — "Plums"
- URL: https://www.canr.msu.edu/resources/michigan_fresh_plums
- Publisher: Michigan State University Extension
- Retrieved: 2026-09-16

> "Pick or purchase fruits that are not bruised or damaged."

> "Wash plums under cool running Do not use soap." [sic — as fetched]
