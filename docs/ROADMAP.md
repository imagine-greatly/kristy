...
| visuals | 18 colorsets, **0 imagesets**. App icon exists (`AppIcon_1024.png`, 1024², universal) but is the **dark-stock brand**: near-black ground, brass hair silhouette. Seal (coin 1, mark as drawn, `KristySealCoin`) is the empty landing's mark only, built
kristy-ios `9681a42` (2026-09-24); the logo composited on the forest plate is the icon and the scan card's earned mark. Warm pass PROPOSED, unbuilt (`warm-pass.md` §0) | `kristy-ios/Kristy/Resources/Assets.xcassets/AppIcon.appiconset/`; `kristy-ios/docs/ios-specs/seal.md`, `warm-pass.md` | no |
...
imagesets), the seal is the empty landing's mark only (2026-09-24), and the only ambient line on iOS is the
...
**Visuals.** Ruled 2026-09-24: the seal (Higgsfield coin 1b3422e7, mark as drawn) is the empty landing's
mark only, built (kristy-ios `9681a42`); the icon is the logo composited on the forest plate in code. Remaining choice: (a) icon only; (b) (a) + six section plates
...
6. No seal anywhere (ruled 2026-09-24). App icon = `Brand/kristy-logo.png` composited on a
   forest `#14472F` square in code, single 1024 universal, `Contents.json` already single-size,
   opaque; no Higgsfield generation. No wordmark (ruled NO 2026-09-22). Verification:
...
7. Retired (ruling A, 2026-09-24): the scan card's logo corner mark is specced in kristy-ios
   `surfaces.md` "Scan card" and is unbuilt.
